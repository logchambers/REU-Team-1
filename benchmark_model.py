### Invoke this through meta_train.sh
...
datasets = ["png_data_256", "fft_data_256"]
learn_rates = [1e-9, 1]

exec('from models.benchmarking.{} import getModel, evaluateModel, getVersion, getDataType'.format(model_name))
...
# best_model = tf.keras.models.load_model( log_dir+"best_model/", custom_objects={"IOU_metric":IOU_metric} )
